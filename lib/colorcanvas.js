...
(function() { this.ColorCanvas || (this.ColorCanvas = {}); this.ColorCanvas["picker/views/display"] = function(__obj) {
    if (!__obj) __obj = {};
...
(function() {
  ...
  ColorCanvas.Gradient = (function(_super) {
    ...
    Gradient.prototype.setColor = function(color, pure) {
      this.color = color;
      this.pure = pure != null ? pure : this.color.toPure();
      return this.render();
    };
...
(function() {
  ...
  ColorCanvas.Picker = (function(_super) {
    ...
    Picker.prototype.render = function() {
      ...
      this.spectrum.bind('change', function(pure_color) {
        var color, hsv;
        ...
        color = new Color(hsv);
        _this.color.set(color.toRGB());
        _this.gradient.setColor(_this.color, pure_color);
        _this.display.setColor(_this.color);
        _this.alpha.setColor(_this.color);
        return _this.change();
      });
